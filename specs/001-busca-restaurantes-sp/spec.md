...
- A base de dados sera populada via script de seed com todos os restaurantes reais disponíveis no OpenStreetMap para São Paulo (atualmente ~2.481), obtidos via Overpass API, com geolocalizacao verificada, enderecos reais e 234 bairros distintos, antes da primeira demonstracao.

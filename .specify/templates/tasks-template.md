...
- [ ] T004 [P] Define performance budget and baseline measurement approach
...
- [ ] T011 Define shared UX patterns (loading/empty/success/error) and copy guidelines
...
- [ ] T014 [P] [US1] Unit test coverage for core business logic in tests/unit/test_[name].py
...
- [ ] T020 [US1] Validate UX consistency for story states and messages
- [ ] T021 [US1] Validate story performance against defined budget
...
- [ ] T024 [P] [US2] Unit test coverage for core business logic in tests/unit/test_[name].py
...
- [ ] T028 [US2] Validate UX consistency for story states and messages
- [ ] T029 [US2] Validate story performance against defined budget
...
- [ ] T033 [P] [US3] Unit test coverage for core business logic in tests/unit/test_[name].py
...
- [ ] T037 [US3] Validate UX consistency for story states and messages
- [ ] T038 [US3] Validate story performance against defined budget
...
Task: "Unit test coverage for core business logic in tests/unit/test_[name].py"
...
- Validate UX consistency and performance budget for each story before marking it done
